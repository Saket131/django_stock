...
def home(request):
	...
	if request.method == 'POST':
		...
		#pk_a664f86d59ed461a8e5319005077e610

		api_request = requests.get("https://cloud.iexapis.com/stable/stock/" + ticker + "/quote?token=pk_a664f86d59ed461a8e5319005077e610")
...
def add_stock(request):
	...
	if request.method == 'POST':
		...
		for ticker_item in ticker:
			api_request = requests.get("https://cloud.iexapis.com/stable/stock/" + str(ticker_item) + "/quote?token=pk_a664f86d59ed461a8e5319005077e610")
